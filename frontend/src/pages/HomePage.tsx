...
const HomePage: React.FC = () => {
  ...
  // Slow auto-scroll to bottom of page
  useEffect(() => {
    ...
    const startAutoScroll = () => {
      ...
      const timeout = setTimeout(() => {
        ...
        console.log('Starting auto-scroll:', { scrollHeight, clientHeight, maxScroll });
        
        if (maxScroll > 0 && isScrolling) {
          const startScrollY = window.scrollY || document.documentElement.scrollTop || 0;
          const scrollDistance = maxScroll - startScrollY;
          ...
          const scrollStep = (currentTime: number) => {
            ...
            const targetScroll = startScrollY + scrollDistance * easeInOut;
            ...
            if (progress < 1 && isScrolling && !isUserScrolling) {
    ...
    const handleManualScroll = () => {
      // Don't stop immediately - allow our scroll to continue
      // Only mark as user scrolling if they actually interact
    };
    ...
    const cleanupTimeout = startAutoScroll();
