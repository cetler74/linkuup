#!/usr/bin/env python3
"""Update Pro plan trial_days to 0 using the app's database connection"""
import asyncio
import sys
...
async def update_pro_trial_days():
    ...
    async with async_session() as db:
        ...
        if pro_plan.trial_days == 0:
            ...
            print(f"✅ Updated Pro plan: trial_days={pro_plan.trial_days} (was {pro_plan.trial_days})")
